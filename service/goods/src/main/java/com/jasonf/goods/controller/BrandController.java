...
import com.jasonf.goods.pojo.Brand;
import com.jasonf.goods.service.BrandService;
...
public class BrandController {
    ...
    public Result findByCategoryName(@PathVariable("category") String categoryName) {
        List<Map> list = brandService.findByCategoryName(categoryName);
